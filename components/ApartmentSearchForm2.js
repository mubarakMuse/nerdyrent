...
function ApartmentSearchForm() {
        ...
        .upsert([
          {
            ...
            location: places.map((option) => option.formatted_address),
            beds: formData.beds,
  ...
  <button
    ...
    className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-red-300 transition duration-150"
  >
    Close
  </button>
</div>
